...
router.get('/my-teams-student', authenticateToken, authorizeRoles('ESTUDIANTE', 'DOCENTE'), teamController.getMyTeamsAsStudent);

// Administradores y coordinadores pueden crear equipos
